...
SINK_NAME = 'alsa_output.usb-Kingston_HyperX_Virtual_Surround_Sound_00000000-00.analog-stereo'
METER_RATE = 344
...
def main():
    ...
    for sample in monitor:
        ...
        bar = '>' * sample
        if i >= 5:
            #print(' %3d %s%s\r' % (sample, bar, spaces),sys.stdout.flush())
            print(sample)
            s=0
            i=0
            ser.write(str(sample)+'\n'.encode())
            ser.flushInput()
